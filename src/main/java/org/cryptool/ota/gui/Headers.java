...
import org.cryptool.ota.OTAApplication.Mode;
...
public class Headers {
    ...
    public static void updateHeadersAndBottom() {
        ...
        if (OTAApplication.colors.changed() || OTAApplication.key.changed() || TranscribedImage.changed()) {
    ...
    public static HBox initLegend() {
        ...
        Timeline tl = new Timeline(
                new KeyFrame(Duration.millis(1000),
                        event -> {
                            boolean changed = OTAApplication.colors.changed() || OTAApplication.key.changed() || TranscribedImage.changed()
