...
public class ImageUtils {
    ...
    public static WritableImage gaussianBlur(Image image2, double blurRadius) {
        GaussianBlur gaussianBlur = new GaussianBlur();
    ...
    public static WritableImage contrast(Image imageIn, double contrast) {
        ImageView iv = new ImageView(imageIn);
        ColorAdjust colorAdjust = new ColorAdjust();
        colorAdjust.setContrast(contrast);
        iv.setEffect(colorAdjust);
    ...
    public static WritableImage binarize(Image imageIn, double maxGrayScale) {
        PixelReader reader = imageIn.getPixelReader();
        final int width = (int) imageIn.getWidth();
        final int height = (int) imageIn.getHeight();
