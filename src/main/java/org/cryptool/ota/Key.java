...
public class Key {
    ...
    boolean fromTranscriptionAvailable(String transcription) {
        if (!isKeyAvailable()) {
            return false;
        }
    ...
    String fromTranscriptionOrDefault(String transcription, String defaultValue) {
        if (!isKeyAvailable()) {
            return null;
        }
    ...
    String fromTranscription(String transcription) {
        if (!isKeyAvailable()) {
            return null;
        }
    ...
    boolean fromColorStringAvailable(String colorString) {
        if (!isKeyAvailable()) {
            return false;
        }
    ...
    String fromColorString(String colorString) {
        if (!isKeyAvailable()) {
            return null;
        }
        String transcription = Main.colors.get(colorString);
    ...
    static Key readFromFile(String filename) {
    ...
    void replace(Key newKey, String metadata) {
        key.clear();
    ...
    static boolean lockedC(String c) {
        return c.toLowerCase().startsWith("_");
    }

    boolean lockedHomophoneP(String c) {
        if (lockedC(c)) {
            return false;
        }
