...
public class Utils {
    ...
    static void adjustHorizontalScrollBar(ScrollPane scrollPane, Node reference, double scaleValue, double increment) {
        ...
        double xMargin = w;
//        System.out.printf("[Contents: total: %.0f Visible: %.0f-%.0f] [Node: x: %.0f w: %.0f]\n",
//                contentHeight, lowestXPixelShown, highestXPixelShown, x, w);
    ...
    static void adjustVerticalScrollBar(ScrollPane scrollPane, Node reference, double scaleValue, double increment) {
        ...
        double yMargin = h;
//        System.out.printf("[Contents: total: %.0f Visible: %.0f-%.0f] [Node: y: %.0f h: %.0f]\n",
//                contentHeight, lowestYPixelShown, highestYPixelShown, y, h);
    ...
    static double[] setAndGetSize(Text helper, Font font, double wrappingWidth) {
        helper.setFont(font);
